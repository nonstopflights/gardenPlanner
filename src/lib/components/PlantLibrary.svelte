<script lang="ts">
	...
	let { plants, images, onPlantClick, onAddPlant, onFilteredChange, printBedPlanHref }: Props = $props();
	...
	<div class="mb-6 flex flex-wrap items-center gap-2">
		...
		{#if printBedPlanHref}
			...
			<a
				...
				class="inline-flex h-8 items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3 text-xs font-semibold text-slate-600 transition hover:border-slate-300 hover:text-slate-900"
			>
